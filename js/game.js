let score = 0, health = 3, timeLeft = 60;
    ...
    // Preload sounds
    backgroundAudio = new Audio('Ghost-Hunter/sounds/background.mp3');
    backgroundAudio.loop = true;
    gunshotSound = new Audio('Ghost-Hunter/sounds/gunshot.mp3');
    hitSound = new Audio('Ghost-Hunter/sounds/hit.wav');
    bonusSound = new Audio('Ghost-Hunter/sounds/bonus.wav');
    healthLossSound = new Audio('Ghost-Hunter/sounds/health_loss.mp3');
    gameOverSound = new Audio('Ghost-Hunter/sounds/gameover.mp3');
    countdownSound = new Audio('Ghost-Hunter/sounds/123Go.mp3');
